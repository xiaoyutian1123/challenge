...
parser.add_argument('--PCB', action='store_true', help='use Part-based Convolutional Baseline (PCB)')
parser.add_argument('--multi', action='store_true', help='use multiple query' )
# parser.add_argument('--fp16', action='store_true', help='use fp16.' )
parser.add_argument('--scale_test', action='store_true', help='scale test' )
parser.add_argument('--ms',default='1', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
parser.add_argument('--query_name', default='query_name.txt', type=str,help='load query image')
...
opt.block = config.get('block', False)
opt.PCB = config.get('PCB', False)
